...
### Страничная структура F/NAV
F/NAV использует простую страничную организацию, отличную от подкадровой структуры I/NAV:
- Каждые 10 секунд передаётся одна страница
- Страница содержит 244 бита (238 информационных + 6 хвостовых)
- К 238 битам информации добавляется 24-битный CRC
- После кодирования получается 500 символов (12 синхрослово + 488 данные)

```
Страница F/NAV (10 секунд)
...
- **δ(A^1/2)**: Поправка к квадратному корню большой полуоси (11 бит, LSB = 2^-9 м^1/2)
...
Шестнадцатеричное представление: 0x864CFB
