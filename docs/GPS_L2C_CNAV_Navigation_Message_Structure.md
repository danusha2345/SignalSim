...
*Примечание: Для сигнала L2C стандарт IS-GPS-200N определяет типы сообщений 10, 11 и 30-37. Типы 12, 13, 14 зарезервированы или используются в других сигналах (L5 CNAV).*
...
- **t_op**: 11 бит (интервал прогноза данных)
- **URA_oe index**: 5 бит (индекс точности)
...
- **M_0**: 33 бита (средняя аномалия на момент t_oe), масштаб: 2^-32 полуокружностей
- **e**: 33 бита (эксцентриситет), масштаб: 2^-34
- **sqrt(A)**: 33 бита (квадратный корень большой полуоси), масштаб: 2^-20 метров^1/2

#### Содержимое типа сообщения 11:
- **t_oe**: 11 бит (должен совпадать с MT 10)
- **Ω_0**: 33 бита (долгота восходящего узла на t_oe), масштаб: 2^-32 полуокружностей
- **i_0**: 33 бита (наклонение на t_oe), масштаб: 2^-32 полуокружностей
- **ω**: 33 бита (аргумент перигея), масштаб: 2^-32 полуокружностей
- **Ω_dot**: 25 бит (скорость прецессии восходящего узла), масштаб: 2^-44 полуокружностей/сек
- **i_dot**: 15 бит (скорость изменения наклонения), масштаб: 2^-44 полуокружностей/сек
- **Δn**: 17 бит (поправка к среднему движению), масштаб: 2^-44 полуокружностей/сек
...
*Примечание: MT 14 зарезервирован в L2C CNAV, но используется в других сигналах (L5 CNAV)*
...
- **a_f0**: 26 бит (смещение часов), масштаб: 2^-34 секунд
- **a_f1**: 20 бит (дрейф часов), масштаб: 2^-46 секунд/секунда
- **a_f2**: 10 бит (ускорение дрейфа часов), масштаб: 2^-59 секунд/секунда²
...
- **t_EOP**: 16 бит (время привязки данных EOP), масштаб: 2^4 секунд
- **PM_X**: 21 бит (движение полюса X), масштаб: 2^-20 угловых секунд
- **PM_X_dot**: 15 бит (скорость движения полюса X), масштаб: 2^-31 угловых секунд/день
- **PM_Y**: 21 бит (движение полюса Y), масштаб: 2^-20 угловых секунд
- **PM_Y_dot**: 15 бит (скорость движения полюса Y), масштаб: 2^-31 угловых секунд/день
- **ΔUT1**: 31 бит (UT1-UTC), масштаб: 2^-24 секунд
- **ΔUT1_dot**: 19 бит (скорость UT1-UTC), масштаб: 2^-35 секунд/день
...
- **Порождающие полиномы**: 
  - G1 = 133 (восьмеричная) = 1011011 (двоичная)
  - G2 = 171 (восьмеричная) = 1111001 (двоичная)
