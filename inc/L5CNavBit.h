//----------------------------------------------------------------------
// L5CNavBit.h:
//   Declaration of navigation bit synthesis class for L5 CNAV
//
//          Copyright (C) 2020-2029 by Jun Mo, All rights reserved.
//
//----------------------------------------------------------------------

#ifndef __L5_CNAV_BIT_H__
#define __L5_CNAV_BIT_H__

#include "NavBit.h"

class L5CNavBit : public NavBit
{
public:
	L5CNavBit();
	~L5CNavBit();
...
private:
	...
	unsigned char ConvEncodeBits[32];
